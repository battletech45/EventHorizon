...
const Hero = (props: Props) => {
  return (
    <div className="flex flex-col items-center h-min p-3">
      ...
      <Image src={heroPhotoSecond} alt="discoLight" width={110} height={144} className="md: w-[300px]"/>
      </div>
      <div className=" border-[1px] md:border-2 border-black rounded-sm md:rounded-md items-center justify-between p-1 flex w-full max-w-5xl">
